const majorArcana = [
    { name: "The Fool", image: "assets/tarot/the-fool.png", meaning: "New beginnings, spontaneity, freedom", score: 70 },
    { name: "The Magician", image: "assets/tarot/the-magician.png", meaning: "Manifestation, resourcefulness, power", score: 90 },
    { name: "The High Priestess", image: "assets/tarot/the-high-priestess.png", meaning: "Intuition, mystery, wisdom", score: 50 },
    { name: "The Empress", image: "assets/tarot/the-empress.png", meaning: "Abundance, nature, nurturing", score: 85 },
    { name: "The Emperor", image: "assets/tarot/the-emperor.png", meaning: "Authority, structure, control", score: 90 },
    { name: "The Hierophant", image: "assets/tarot/the-hierophant.png", meaning: "Tradition, morality, spirituality", score: 75 },
    { name: "The Lovers", image: "assets/tarot/the-lovers.png", meaning: "Love, harmony, relationships", score: 80 },
    { name: "The Chariot", image: "assets/tarot/the-chariot.png", meaning: "Determination, willpower, success", score: 95 },
    { name: "Strength", image: "assets/tarot/strength.png", meaning: "Courage, strength, patience", score: 85 },
    { name: "The Hermit", image: "assets/tarot/the-hermit.png", meaning: "Introspection, solitude, guidance", score: 45 },
    { name: "Wheel of Fortune", image: "assets/tarot/wheel-of-fortune.png", meaning: "Luck, cycles, destiny", score: 95 },
    { name: "Justice", image: "assets/tarot/justice.png", meaning: "Fairness, truth, law", score: 70 },
    { name: "The Hanged Man", image: "assets/tarot/the-hanged-man.png", meaning: "Pause, surrender, letting go", score: 40 },
    { name: "Death", image: "assets/tarot/death.png", meaning: "Endings, transformation, change", score: 60 },
    { name: "Temperance", image: "assets/tarot/temperance.png", meaning: "Balance, moderation, patience", score: 85 },
    { name: "The Devil", image: "assets/tarot/the-devil.png", meaning: "Addiction, materialism, playfulness", score: 35 },
    { name: "The Tower", image: "assets/tarot/the-tower.png", meaning: "Upheaval, disaster, awakening", score: 25 },
    { name: "The Star", image: "assets/tarot/the-star.png", meaning: "Hope, inspiration, faith", score: 90 },
    { name: "The Moon", image: "assets/tarot/the-moon.png", meaning: "Illusion, intuition, uncertainty", score: 50 },
    { name: "The Sun", image: "assets/tarot/the-sun.png", meaning: "Success, vitality, positivity", score: 100 },
    { name: "Judgement", image: "assets/tarot/judgement.png", meaning: "Reflection, reckoning, awakening", score: 80 },
    { name: "The World", image: "assets/tarot/the-world.png", meaning: "Completion, wholeness, accomplishment", score: 95 }
];
